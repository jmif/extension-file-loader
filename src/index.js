...
export default function loader(content) {
  ...
  return `module.exports = (global.window && global.window.browser && global.window.browser.extension) ? global.window.browser.extension.getURL('${publicPath}') : '${publicPath}'`;
}
